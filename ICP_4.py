...
lin_model = svm.SVC(kernel='linear', C=1).fit(X_train, y_train)
print("Linear SVM Prediction: ", lin_model.predict([[1, 2, 3, 4], [2, 3, 4, 5]]))
print("Accuracy: ", lin_model.score(x, y))
...
RBF_model = svm.SVC(gamma= 'auto', kernel='rbf', C=1).fit(X_train, y_train)
print("Linear SVM with RBF Prediction: ", RBF_model.predict([[1, 2, 3, 4], [2, 3, 4, 5]]))
print("Accuracy: ", RBF_model.score(x, y))
